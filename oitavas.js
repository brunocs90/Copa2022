...
function createGame(player1, hour, player2, homeTeamScore, awayTeamScore) {
    const iconFlagPlayer1 = (player1.startsWith('1') || player1.startsWith('2')) === true ? "unknown" : player1;
    const iconFlagPlayer2 = (player2.startsWith('1') || player2.startsWith('2')) === true ? "unknown" : player2;
    return `
	<li>
		<figure>
